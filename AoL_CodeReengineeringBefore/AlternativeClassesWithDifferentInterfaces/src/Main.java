...
public class Main {
	...
	public static void main(String[] args) {
        ...
        double totalPriceEUR = converter.convert("EUR",totalPriceUSD);
        System.out.println("Total price in EUR: " + String.format("%.2f", totalPriceEUR));

        // Ubah total harga ke IDR
        double totalPriceIDR = converter.convert("IDR", totalPriceUSD);
        System.out.println("Total price in IDR: Rp " + String.format("%.0f", totalPriceUSD));
	}
